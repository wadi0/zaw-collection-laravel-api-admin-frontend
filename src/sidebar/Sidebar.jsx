...
const Sidebar = ({ isVisible, onClose }) => {
  ...
  const isPathActive = (href) => {
    ...
    if (!targetPath.startsWith("/")) {
      ...
      return (
        ...
        currentPath.endsWith(`/${pathSegment}`)
      );
    }
  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { id: "pending-orders", label: "Pending", path: path.pending}, //`/${path.orders}/pending`},
        { id: "completed-orders", label: "Completed", path: path.completed}, //`/${path.orders}/completed`}
      ],
    },
    {
      id: "customers",
      label: "Customers",
      icon: Users,
      path: path.customer, //'/admin/customers',
      badge: null,
    },
    {
      id: "reports",
      ...
      icon: TrendingUp,
      children: [
        { id: "sales-report", label: "Sales Report", path: path.sales_reports }, //'/admin/reports/sales'},
        { id: "analytics", label: "Analytics", path: path.analytics }, //'/admin/reports/analytics'},
        { id: "export", label: "Export Data", path: path.export_data }, //'/admin/reports/export'}
      ],
    },
    {
      id: "shipping",
      label: "Shipping",
      icon: Truck,
      path: path.shipping, //'/admin/shipping',
      badge: null,
    },
    {
      id: "settings",
      label: "Settings",
      icon: Settings,
      path: path.settings, //'/admin/settings',
      badge: null,
    },
  ];
  ...
  useEffect(() => {
    const currentItem = menuItems.find(
      (item) => item.children && hasActiveChild(item.children)
    );
    if (currentItem) {
